...
.. tip::
    ...
    This is only the Getting Started guide for the Storybook TYPO3 extension.

    * For extended information about Storybook itself, see the `Storybook documentation <https://storybook.js.org/docs>`_.
    * For extended information about TYPO3 components, see the `TYPO3 Components documentation <https://docs.typo3.org/permalink/fluid:components>`_.
    * For extended information about EXT:storybook, see the `README.md <https://github.com/andersundsehr/storybook/blob/main/README.md>`_.
...
..  card-grid::
    ...
    ..  card:: :ref:`Why and Why Not? <whyAndWhyNot>`

        Learn about component-based development and why Storybook is a great tool for it.

    ..  card:: :ref:`First Fluid Component <firstFluidComponent>`
    ...
    ..  card:: :ref:`Transformers <transformers>`
